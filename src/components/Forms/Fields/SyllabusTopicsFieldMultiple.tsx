...
const SyllabusTopicsFieldMultiple = ({
  topics,
  updateTopics,
  selectedTopicState,
}: Props) => {
  ...
  return (
    <VStack align="stretch" spacing={3}>
      {topics.map((topic, index) => {
        const isSelected = selectedTopic && selectedTopic.includes(index);
        return (
          <Box
            key={index}
            borderWidth="1px"
...
export default SyllabusTopicsFieldMultiple;
